...
export function GoogleLoginButton({ disabled = true, oauthConfigured = false }) {
  return (
    <div className="w-full space-y-2.5">
      <Button
        variant="outline"
        className="w-full h-11 gap-3 font-semibold text-sm border-border hover:bg-muted/50 transition-colors"
        disabled={disabled || !oauthConfigured}
